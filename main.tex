...
\usepackage[hscale=0.8,vscale=0.9,vmarginratio=3:2]{geometry}
...
\cvitem{\textbf{}}{Data scientist with expertise in unsupervised and supervised deep learning, computer vision, classification problems and a strong mathematical foundation.}
